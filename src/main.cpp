...
int main()
{
	...
	try
	{
		ByxParser parser("var g1 = 100; public var g2 = 3.14; var g3 = g1 + 2.5;  function f(n) { return n * n; } public function main(){ var i = 100; var j = 3.14; var s = 0; for (var i = 0; i < 6; i = i + 1) { s = s + i; } }");
		parser.parse();
